...
namespace UdemyIdentityServer.AuthServer
{
    public static class Config
    {
        ...
        public static IEnumerable<TestUser> GetUsers()
        {
            ...
            {
                new TestUser{SubjectId="1",Username="ehlkara",Password="123qwe",Claims=new List<Claim>(){
                ...
                new TestUser{SubjectId="2",Username="ehlkara2",Password="123qwe",Claims=new List<Claim>(){
                new Claim("given_name","Ehlullah2"),
                new Claim("family_name","Karakurt2"),
                new Claim("country","Türkiye"),
            ...
            return new List<Client>(){
                ...
                new Client()
                {
                    ...
                    AllowedScopes={IdentityServerConstants.StandardScopes.OpenId,
                        IdentityServerConstants.StandardScopes.Profile,"api1.read",IdentityServerConstants.StandardScopes.OfflineAccess,"CountryAndCity","Roles"},

                    AccessTokenLifetime=2*60*60, // Birinci yol token ömrü vermek için
                    AllowOfflineAccess=true,
                    RefreshTokenUsage=TokenUsage.ReUse,
                    RefreshTokenExpiration=TokenExpiration.Absolute,
                    AbsoluteRefreshTokenLifetime=(int)(DateTime.Now.AddDays(60)-DateTime.Now).TotalSeconds,// İkinci yol token ömrü vermek için
                ...
                new Client()
                {
                    ...
                    AllowedScopes={IdentityServerConstants.StandardScopes.OpenId,
                        IdentityServerConstants.StandardScopes.Profile,"api1.read","api2.read",IdentityServerConstants.StandardScopes.OfflineAccess,"CountryAndCity","Roles"},
                    AccessTokenLifetime=2*60*60, // Birinci yol token ömrü vermek için
                    AllowOfflineAccess=true,
                    RefreshTokenUsage=TokenUsage.ReUse,
                    RefreshTokenExpiration=TokenExpiration.Absolute,
